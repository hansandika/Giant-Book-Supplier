...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
        $book1 = Book::create([
            ...
            'image' => 'MV5BN2EyZjM3NzUtNWUzMi00MTgxLWI0NTctMzY4M2VlOTdjZWRiXkEyXkFqcGdeQXVyNDUzOTQ5MjY@._V1_.jpg',
        ]);
        ...
        $book2 = Book::create([
            ...
            'image' => "Harry_Potter_and_the_Philosopher's_Stone_banner.jpg",
        ]);
